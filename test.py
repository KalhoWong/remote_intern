...
from template import ADTM,alpha74,alpha124,CCI5,MTMMA,NetProfitGrowRate3Y,quick_ratio,TotalAssetTrate

for f in ['ADTM','alpha74','alpha124','CCI5','MTMMA','NetProfitGrowRate3Y','quick_ratio','TotalAssetTrate']:
